...
# Adding Treatment, Pasture, and Patch Columns ----------------------------
...
raw$Replicate <- ifelse(raw$Transect >= 133,
                        "NW",
...
raw$Intensity <- ifelse(raw$Treatment == "MTORG" & raw$Year == 2021 & raw$Patch %in% c(1, 5, 12, 16), "Heavy",
                                                                                ...
                                                                                ifelse(raw$Treatment == "MTORG" & raw$Year == 2023 & raw$Patch %in% c(4, 8, 11, 15), "Full",
                                                                                       ifelse(raw$Treatment == "MTORG" & raw$Year == 2023 & raw$Patch %in% c(1, 5, 12, 16), "Moderate",
                                                                                              ifelse(raw$Treatment == "MTORG" & raw$Year == 2023 & raw$Patch %in% c(2, 6, 9, 13), "Rest",
                                                                                                     ifelse(raw$Treatment == "MTORG" & raw$Year == 2024 & raw$Patch %in% c(3, 7, 10, 14), "Rest",
                                                                                                            ifelse(raw$Treatment == "MTORG" & raw$Year == 2024 & raw$Patch %in% c(4, 8, 11, 15), "Heavy",
                                                                                                                   ifelse(raw$Treatment == "MTORG" & raw$Year == 2024 & raw$Patch %in% c(1, 5, 12, 16), "Full",
                                                                                                                          ifelse(raw$Treatment == "MTORG" & raw$Year == 2024 & raw$Patch %in% c(2, 6, 9, 13), "Moderate",
                                                                                                                                 ""))))))))))))))))
...
write_csv(MTORG.veg, "working/MTORG_str.csv")
